    ...
    <section id="testimonial" className="py-16" ref={testimonialRef}>
        ...
        <div className="px-4">
            <div className="flex flex-col items-center text-center">
                <img src={TESTIMONIAL.image} alt={TESTIMONIAL.name} className="testimonial-image mb-6 h-24 rounded-full border-4 object-cover"/>
                <blockquote className=" testimonial-quote max-w-xl text-lg leading-relaxed lg:text-2xl">&quot;{TESTIMONIAL.quote}&quot;</blockquote>
